package com.example.jayson.resolvecitycode.indexbar;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_RED_ = Color.parseColor("#00a7d3");
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), paddingLeft, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
